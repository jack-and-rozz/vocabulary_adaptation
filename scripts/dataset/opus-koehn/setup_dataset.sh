...
archive_dir=$opus_koehn_data_root/dataset 
...
# We used preprocessed files (including tokenization and truecasing) made by (Koehn+, '17), so we just create symbolic links in this script.
